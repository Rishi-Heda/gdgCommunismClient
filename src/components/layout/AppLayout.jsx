...
const AppLayout = () => {
  ...
  return (
    <div
      className="min-h-screen bg-background-base text-text-primary overflow-x-hidden selection:bg-accent-primary selection:text-background-base font-sans transition-colors duration-700"
